...
func (export *Export) GetStatusString() string {
	...
	case label.AttributeLabelTaskStatusSuccess:
		return pb.TaskStatus_SUCCESS.String()
	case label.AttributeLabelTaskStatusPending:
		return pb.TaskStatus_PENDING.String()
	case label.AttributeLabelTaskStatusRunning:
		return pb.TaskStatus_RUNNING.String()
	case label.AttributeLabelTaskStatusFailed:
