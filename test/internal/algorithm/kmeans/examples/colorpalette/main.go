...
import (
	...
	"git.woa.com/dialogue-platform/bot-config/bot-knowledge-config-server/internal/algorithm/kmeans/plotter"
...
func (c Color) Coordinates() cluster.Coordinates {
	l, a, b := c.Lab()
	return cluster.Coordinates{l, a, b}
}

func (c Color) Distance(pos cluster.Coordinates) float64 {
