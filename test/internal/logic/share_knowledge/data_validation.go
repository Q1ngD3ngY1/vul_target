...
// NewNonEmptyValidator 创建非空验证
func NewNonEmptyValidator() Validator {
	return &NonEmptyValidator{}
}

// Execute 执行检查
func (v *NonEmptyValidator) Execute(data interface{}) bool {
	if data == nil {
		return false
	}
...
// Execute 执行检查
func (v *RangeValidator) Execute(data interface{}) bool {
	if data == nil {
		return false
	}
