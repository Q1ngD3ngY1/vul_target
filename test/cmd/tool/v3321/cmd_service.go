...
func New(rpc *rpc.RPC, d dao.Dao, auditLogic *auditLogic.Logic, cacheLogic *localcache.Logic, docLogic *docLogic.Logic, qaLogic *qa.Logic,
	...
	kbDao kbdao.Dao, labelDao labeldao.Dao, financeLogic *finance.Logic, adminRdb types.AdminRedis, promptDao llm.Dao, thirdDocLogic *third_document.Logic) *CmdService {
	srv := CmdService{
		RpcImpl:       rpc,
